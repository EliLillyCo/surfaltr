...
format_ids <- function(final_pairs){
  ...
  alt_trans <- dplyr::rename(alt_trans, "uniprot_isoform" = "uniprot_isoform.x")
  alt_trans <- dplyr::rename(alt_trans, "uniprotsptrembl" = "uniprotsptrembl.x")
  alt_trans <- dplyr::rename(alt_trans, "uniprotswissprot" = "uniprotswissprot.x")
  ...
  prim_trans <- dplyr::rename(prim_trans, "uniprot_isoform" = "uniprot_isoform.y")
  prim_trans <- dplyr::rename(prim_trans, "uniprotsptrembl" = "uniprotsptrembl.y")
  prim_trans <- dplyr::rename(prim_trans, "uniprotswissprot" = "uniprotswissprot.y")
